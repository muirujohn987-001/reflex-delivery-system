...
export default function MobileNavbar() {
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 flex items-stretch justify-around border-t border-gray-100 bg-white pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_16px_rgba(17,17,17,0.06)] lg:hidden"
    >
      {ITEMS.map((item) => (
        <NavLink
          key={item.label}
